...
public class ToolsFragment<T extends Transaction> extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        resetModifiedProjections.setOnClickListener( v -> {
            ArrayList<T> allTransactions = mViewModel.getActiveTransactions();

            allTransactions.forEach( transaction -> {
                ArrayList<ProjectedTransaction> allTransactionProjections = mViewModel.getProjections( (Transaction) transaction );
        ...
        deleteRecords.setOnClickListener( v -> {
            ArrayList<RecordedTransaction> allRecords = mViewModel.getRecords( R.string.records_type_all );
